...
<body>
  ...
  <p>
    We provide Custom furniture for all types of furniture.
  </p>
  <br />
  <form action="customfurniture.php" method="post">
    <fieldset>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->query($sql2) === TRUE) {
      ...
      if ($conn->query($sql3) === TRUE) {
        header("location: customfurniture.php");
      } else {
